...
const ParkingOfferListItem: React.FC<ParkingOfferListItemProps> = ({ parkingOffer, isCanAddComment, isCanAddImage }) => {
  ...
  return (
    <IonItem routerLink={`/parkingOffer/${parkingOffer.id}?canAddComment=${isCanAddComment || false}&canAddImage=${isCanAddImage || false}`} detail={false}>
